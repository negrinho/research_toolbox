...
def get_gpu_information():
    gpus = []
    try:
        convert_to_gigabytes = lambda x: tb_rs.convert_between_byte_units(x,
...
def set_single_visible_available_gpu(
        memory_threshold_in_gigabytes=0.1, utilization_threshold_in_percent=5.0):
    gpu_id = get_available_gpu(
        memory_threshold_in_gigabytes, utilization_threshold_in_percent)
