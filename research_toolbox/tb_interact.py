...
# NOTE: edit according to the configuration needed.
servername = 'bridges.psc.xsede.org'
username = 'myname' # your username HERE.
local_folderpath = '/Users/renato.negrinho/Workspace/darch_newest1'
remote_folderpath = '/home/%s/darch_newest1' % username
main_relfilepath = 'examples/tensorflow/mnist/main.py'
...
def write_server_run_script():
    ...
    jobname = 'benchmark'
    time_budget_in_hours = 1 # max 48 hours
    mem_budget_in_gb = 10
